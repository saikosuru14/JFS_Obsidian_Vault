...
| **[[Merge Intervals]]** | overlapping ranges, scheduling | Arrays |
...
| **[[Frequency Counting Pattern]]** | tally counts (anagrams, top-k) | Hashing |
| **[[Monotonic Stack]]** | next greater/smaller element | Stacks |
| **[[BFS]] / [[DFS]]** | trees, graphs, grids, levels | Graphs |
| **[[Priority Queue]] / [[Heap]] (top-k)** | k largest/smallest, merge k, stream median | Stacks/Trees |
...
- "Overlapping ranges / meeting rooms / scheduling" -> merge intervals (sort + sweep).
- "Count occurrences / anagrams / top-k frequent" -> frequency counting (map / int[26]).
- "Kth largest / top-k / merge k / stream median" -> heap / priority queue.
